                        ...
                        <div class="d-inline-flex align-items-center pr-2">
                            ...
                            @auth
                                <form action="{{ route('logout') }}" method="POST">
                                    @csrf
                                    <button type="submit" class="text-primary p-2 border-0 bg-transparent">
                                        <i class="fas fa-sign-out-alt"></i>
                                    </button>
                                </form>
                            @else
                                <a class="text-primary p-2" href="{{ route('login') }}">
                ...
                <nav class="navbar navbar-expand-lg bg-white navbar-light p-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            ...
                            <a href="{{ route('about') }}" class="nav-item nav-link {{ $about ?? ' ' }}">About</a>
                            <a href="{{ route('service') }}" class="nav-item nav-link {{ $service ?? ' ' }}">Service</a>
                            <a href="{{ route('project') }}"
                                class="nav-item nav-link {{ $project ?? ' ' }}">Project</a>
                            <a href="{{ route('posts.index') }}" class="nav-link {{ $pages ?? ' ' }}">Blog</a>
                            <a href="{{ route('contact') }}"
                                class="nav-item nav-link {{ $contact ?? ' ' }}">Contact</a>
                        </div>
                        @auth
                            <a href="{{ route('posts.create') }}" class="btn btn-primary mr-3 d-none d-lg-block">
                                Create a post
                            </a>
                        @endauth
                    </div>
